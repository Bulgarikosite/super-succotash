...
// Persist friends
if (Array.isArray(dataPayload.friends)) {
  user.friends = dataPayload.friends;
  delete dataPayload.friends;
}
...
// Always persist inventory if present
if (Array.isArray(dataPayload.inventory)) {
   user.inventory = dataPayload.inventory;
   delete dataPayload.inventory;
}

// Always persist friends if present
if (Array.isArray(dataPayload.friends)) {
   user.friends = dataPayload.friends;
   delete dataPayload.friends;
}
